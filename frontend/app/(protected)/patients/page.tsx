...
export default function Patients(){
  ...
  return <>
    <PageHeader
      ...
      actions={<Link href="/patients/new" className="button-base button-primary"><UserPlus size={17}/>{t("patients.register")}</Link>}
    />
    <Card>
