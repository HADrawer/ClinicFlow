...
vi.mock("@/lib/quick-create",()=>({useQuickCreate:()=>({openPatient:vi.fn(),openAppointment:vi.fn(),close:vi.fn()})}));
...
const user={id:1,clinic_id:1,email:"user@test",full_name:"Test User",role:"owner" as const,is_active:true,permissions:[],clinic:{id:1,name:"Test Clinic",address:"",phone:"",working_hours:{},pharmacy_enabled:false,feature_flags:{}}};
